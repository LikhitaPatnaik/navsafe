...
export const areaCoordinates: Record<string, LatLng> = {
  ...
  'Jagadamba Junction': { lat: 17.7142, lng: 83.3017 },
  'MVP Colony': { lat: 17.7367, lng: 83.2851 },
  'Simhachalam': { lat: 17.7667, lng: 83.2500 },
  'Maddilapalem': { lat: 17.7417, lng: 83.2917 },
  'Anandapuram': { lat: 17.8000, lng: 83.4167 },
  
  // High Risk Areas (safety_score 40-50)
  'Marripalem': { lat: 17.7750, lng: 83.3600 },
  'One Town': { lat: 17.6967, lng: 83.2917 },
  'Steel Plant Township': { lat: 17.6403, lng: 83.1638 },
  'Lawsons Bay Colony': { lat: 17.7200, lng: 83.3400 },
  ...
  'Poorna Market': { lat: 17.7100, lng: 83.2950 },
  ...
  'Sheela Nagar': { lat: 17.6833, lng: 83.2667 },
  'Marikavalasa': { lat: 17.7917, lng: 83.3750 },
  'Bhogapuram': { lat: 17.9167, lng: 83.4833 },
  ...
  'Tagarapuvalasa': { lat: 17.8333, lng: 83.4333 },
  'Boyapalem': { lat: 17.7550, lng: 83.2400 },
  ...
  'Balayya Sastri Layout': { lat: 17.7150, lng: 83.2900 },
  'Andhra University': { lat: 17.7275, lng: 83.3181 },
  'Ghat Road': { lat: 17.7600, lng: 83.2550 },
  'Venkojipalem': { lat: 17.7200, lng: 83.2800 },
  'Daspalla Hills': { lat: 17.6950, lng: 83.2900 },
  'Vishalakshinagar': { lat: 17.7517, lng: 83.3017 },
